...
// TODO: un-comment this and/or update tests to cover the new CA-based implementation.
...
// 	ssh, err := newLocalSSHimmerWithDeps(t.Context(), "test-container", "localhost", "2222", mockFS, mockKG)
// 	if err != nil {
...
// 	// Create sshimmer
// 	_, err := newLocalSSHimmerWithDeps(t.Context(), "test-container", "localhost", "2222", mockFS, mockKG)
// 	if err != nil {
// 		t.Fatalf("Failed to create LocalSSHimmer: %v", err)
// 	}
...
// 	_, err := ssh.getOrCreateKeyPair(keyPath)
// 	if err != nil {
...
// 	ssh := &LocalSSHimmer{
// 		cntrName:         "test-sandbox",
// 		sshHost:          "test-sandbox.test",
// 		sshPort:          "2222",
...
// 	if !strings.Contains(configStr, "Host test-sandbox.test") {
// 		t.Errorf("Container host entry not found in config: %s", configStr)
// 	}

// 	if !strings.Contains(configStr, "HostName test-sandbox.test") {
